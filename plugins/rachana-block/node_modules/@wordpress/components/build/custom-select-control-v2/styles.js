...
const CustomSelectLabel = exports.CustomSelectLabel = ( /*#__PURE__*/0, _base.default)(Ariakit.SelectLabel, process.env.NODE_ENV === "production" ? {
  target: "e1p3eej73"
} : {
  target: "e1p3eej73",
...
const CustomSelectButton = exports.CustomSelectButton = ( /*#__PURE__*/0, _base.default)(Ariakit.Select, process.env.NODE_ENV === "production" ? {
...
const CustomSelectPopover = exports.CustomSelectPopover = ( /*#__PURE__*/0, _base.default)(Ariakit.SelectPopover, process.env.NODE_ENV === "production" ? {
  target: "e1p3eej71"
} : {
  target: "e1p3eej71",
...
const CustomSelectItem = exports.CustomSelectItem = ( /*#__PURE__*/0, _base.default)(Ariakit.SelectItem, process.env.NODE_ENV === "production" ? {
  target: "e1p3eej70"
} : {
  target: "e1p3eej70",
